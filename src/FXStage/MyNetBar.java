...
public class MyNetBar {
    ...
    ObservableList<ImageCell> images;
    private TableView nameTable = new TableView();
    TableView<ImageCell> imageTable;
    VBox root;
    Label nameLabel;
    Label isOnline;
    ...
    public MyNetBar() {
        ...
        TableColumn<ImageCell, String> imageCol = new TableColumn<>("图像名称");
        imageCol.setCellValueFactory(new PropertyValueFactory<>("name"));
        root.getChildren().addAll(nameLabel, isOnline, nameTable);
    }
